  ...
  return (
    <div className="ev">
      <style jsx>{`
        ...
        /* ACCORDION — bulletproofed against parent flex/grid contexts */
        .ev .ev-acc-list {
        ...
        .ev .ev-acc.open { background: var(--surface); }

        /* defeat global button styles with all: unset, then re-apply ours */
        .ev .ev-acc-trig {
          all: unset;
          box-sizing: border-box;
        ...
        .ev .ev-acc-trig:hover { background: rgba(255,255,255,.02); }
        .ev .ev-acc.open .ev-acc-trig { padding: 18px 16px; }
        ...
        .ev .ev-acc.open .ev-acc-num { color: var(--amber); }
        .ev .ev-acc-icn {
          width: 32px;
          height: 32px;
          display: inline-flex;
        ...
        .ev .ev-acc.open .ev-acc-chev { transform: rotate(180deg); color: var(--you); }
        .ev .ev-acc-body {
          display: block;
          padding: 0 16px 22px;
          animation: evDrop .3s ease both;
        }
