...
.pd-show-mentor{display:flex;flex-direction:column;align-items:center;gap:6px;flex-shrink:0}
.pd-show-mentor-photo{width:52px;height:52px;border-radius:8px;overflow:hidden;flex-shrink:0;background:#1a1a1a}
