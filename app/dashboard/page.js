...
.mp-avatar-wrap-ring{position:absolute;width:125px;height:125px;background:linear-gradient(to right,#fd1c00,#ff4e50,#EEA727);border-radius:50% 50% 50% 50%/60% 40% 60% 40%;z-index:0;animation:blobMorph 8s ease-in-out infinite,blobRotate 10s linear infinite,blobSpin 12s linear infinite;box-shadow:0 0 25px rgba(253,28,0,.3),0 0 50px rgba(238,167,39,.15),0 0 80px rgba(253,28,0,.06);border:2px solid rgba(255,255,255,.7);outline:2px solid rgba(255,255,255,.15);outline-offset:4px;}
...
.mp-avatar{width:98px;height:98px;border-radius:50%;background:linear-gradient(135deg,#fd1c00,#EEA727);border:none;display:flex;align-items:center;justify-content:center;font-size:2rem;font-weight:800;color:#fd1c00;overflow:hidden;position:relative;z-index:2;}
