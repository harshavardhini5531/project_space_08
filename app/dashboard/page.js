...
.mp-avatar-wrap-ring{position:absolute;width:120px;height:120px;background:linear-gradient(135deg,#fff,#EEA727);border-radius:50% 50% 50% 50%/60% 40% 60% 40%;z-index:0;animation:blobMorph 8s ease-in-out infinite;box-shadow:0 0 20px rgba(238,167,39,.25),0 0 45px rgba(238,167,39,.12);}
...
.mp-avatar{width:106px;height:106px;border-radius:50%;background:linear-gradient(135deg,#fff,#EEA727);border:none;display:flex;align-items:center;justify-content:center;font-size:2rem;font-weight:800;color:#fd1c00;overflow:hidden;position:relative;z-index:1;}
