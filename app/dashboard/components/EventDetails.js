...
const SCHEDULE = [
  {
    ...
    events: [
      ...
      { time: '11:00 AM', endTime: '', label: 'Snacks', desc: 'Light refreshments served.', kind: 'break', icon: 'coffee' },
      ...
      { time: '3:30 PM', endTime: '', label: 'Snacks', desc: 'Evening refreshments.', kind: 'break', icon: 'coffee' },
      ...
      { time: '9:30 PM', endTime: '', label: 'Snacks', desc: 'Late-night refreshments to keep you fueled.', kind: 'break', icon: 'coffee' },
    ]
  },
  {
    ...
    events: [
      ...
      { time: '10:00 AM', endTime: '11:00 AM', label: 'Guest Interaction', desc: 'Druvith Kumar Rao — Robotics Engineer, Nagano Sankoh Ltd, Japan.', kind: 'guest', icon: 'mic', guests: ['Mr Druvith Kumar Rao · Robotics Engineer, Nagano Sankoh Ltd, Japan'] },
      { time: '11:00 AM', endTime: '', label: 'Snacks', desc: 'Light refreshments.', kind: 'break', icon: 'coffee' },
      ...
      { time: '2:00 PM', endTime: '3:00 PM', label: 'Guest Interaction', desc: 'Druvith Kumar Rao — Robotics Engineer, Nagano Sankoh Ltd, Japan.', kind: 'guest', icon: 'mic', guests: ['Mr Druvith Kumar Rao · Robotics Engineer, Nagano Sankoh Ltd, Japan'] },
      { time: '3:30 PM', endTime: '', label: 'Snacks', desc: 'Evening refreshments.', kind: 'break', icon: 'coffee' },
      ...
      { time: '9:30 PM', endTime: '', label: 'Snacks', desc: 'Late-night fuel.', kind: 'break', icon: 'coffee' },
    ]
  },
  {
    ...
    events: [
      ...
      { time: '10:00 AM', endTime: '11:00 AM', label: 'Guest Interactions', desc: 'Three industry leaders share their journeys.', kind: 'guest', icon: 'mic', guests: ['Mr Sankar · Software Engineer, ZOHO', 'Mr Venkat · Associate Technical Support Engineer, ServiceNow', 'Mr Druvith Kumar Rao · Robotics Engineer, Nagano Sankoh Ltd, Japan'] },
      { time: '11:00 AM', endTime: '', label: 'Snacks', desc: 'Light refreshments.', kind: 'break', icon: 'coffee' },
      { time: '12:00 PM', endTime: '1:30 PM', label: 'Lunch', desc: 'Lunch at dining hall.', kind: 'meal', icon: 'utensils' },
      { time: '2:00 PM', endTime: '3:00 PM', label: 'Afternoon Guest Session', desc: 'Continued industry interactions.', kind: 'guest', icon: 'mic', guests: ['Mr Sankar · Software Engineer, ZOHO', 'Mr Venkat · Associate Technical Support Engineer, ServiceNow', 'Mr Druvith Kumar Rao · Robotics Engineer, Nagano Sankoh Ltd, Japan'] },
      { time: '3:30 PM', endTime: '', label: 'Snacks', desc: 'Evening refreshments.', kind: 'break', icon: 'coffee' },
  ...
  },
  {
    ...
    subtitle: 'Six guests across two sessions — Qualcomm, Dentsu, AWS, ServiceNow, SOTI, and Oracle.',
    accent: '#7B2FBE',
    events: [
      { time: '9:30 AM', endTime: '12:00 PM', label: 'Morning Session', desc: 'Project development with mentors.', kind: 'session', icon: 'sun' },
      { time: '10:00 AM', endTime: '11:00 AM', label: 'Morning Guest Block', desc: 'Five industry experts share insights.', kind: 'guest', icon: 'mic', guests: ['Ms Sri Vidya · Software Engineer, Qualcomm', 'Mr Mohit · Head of Engineering, Dentsu Global Services', 'Mr Saikiran · Cloud Database Engineer, Amazon Web Services', 'Ms Shaik Muzna Jawhar · Associate Technical Support Engineer, ServiceNow', 'Mr Varun · Associate Software Developer, SOTI'] },
      { time: '11:00 AM', endTime: '', label: 'Snacks', desc: 'Refreshments.', kind: 'break', icon: 'coffee' },
      { time: '12:00 PM', endTime: '1:30 PM', label: 'Lunch', desc: 'Lunch break.', kind: 'meal', icon: 'utensils' },
      { time: '2:00 PM', endTime: '3:00 PM', label: 'Afternoon Guest Block', desc: 'Six industry leaders, including a Cloud Director from Oracle.', kind: 'guest', icon: 'mic', guests: ['Mr Arun · Cloud Director, Oracle', 'Ms Sri Vidya · Software Engineer, Qualcomm', 'Mr Mohit · Head of Engineering, Dentsu Global Services', 'Mr Saikiran · Cloud Database Engineer, Amazon Web Services', 'Ms Shaik Muzna Jawhar · Associate Technical Support Engineer, ServiceNow', 'Mr Varun · Associate Software Developer, SOTI'] },
      { time: '3:30 PM', endTime: '', label: 'Snacks', desc: 'Evening refreshments.', kind: 'break', icon: 'coffee' },
  ...
  },
  {
    ...
    title: 'Refinement & Final Touches',
    subtitle: 'DeltaX and Wissda guests — sharpen your project before the showcase days.',
    accent: '#3b82f6',
    events: [
      { time: '9:30 AM', endTime: '12:00 PM', label: 'Morning Session', desc: 'Final project polishing with mentors.', kind: 'session', icon: 'sun' },
      { time: '10:00 AM', endTime: '11:00 AM', label: 'Guest Interaction', desc: 'Industry insights from DeltaX and Wissda.', kind: 'guest', icon: 'mic', guests: ['Mr Omteja · Associate Product Engineer, DeltaX', 'Mr Kowshik · ServiceNow Developer, Wissda'] },
      { time: '11:00 AM', endTime: '', label: 'Snacks', desc: 'Refreshments.', kind: 'break', icon: 'coffee' },
      { time: '12:00 PM', endTime: '1:30 PM', label: 'Lunch', desc: 'Lunch break.', kind: 'meal', icon: 'utensils' },
      { time: '1:30 PM', endTime: '5:00 PM', label: 'Afternoon Session', desc: 'Final preparations and refinement.', kind: 'session', icon: 'sun' },
      { time: '2:00 PM', endTime: '3:00 PM', label: 'Guest Interaction', desc: 'Continued mentorship and Q&A with industry guests.', kind: 'guest', icon: 'mic', guests: ['Mr Omteja · Associate Product Engineer, DeltaX', 'Mr Kowshik · ServiceNow Developer, Wissda'] },
      { time: '3:30 PM', endTime: '', label: 'Snacks', desc: 'Evening refreshments.', kind: 'break', icon: 'coffee' },
      { time: '4:30 PM', endTime: '6:30 PM', label: 'Project Street', desc: 'Project showcase.', kind: 'highlight', icon: 'sparkles' },
      { time: '7:00 PM', endTime: '8:00 PM', label: 'Dinner', desc: 'Dinner break.', kind: 'meal', icon: 'utensils' },
      { time: '9:30 PM', endTime: '', label: 'Snacks', desc: 'Late-night fuel.', kind: 'break', icon: 'coffee' },
  ...
  },
  {
    ...
    subtitle: 'Last full day of building before the grand finale.',
    accent: '#ec4899',
    events: [
      { time: '9:30 AM', endTime: '12:00 PM', label: 'Morning Session', desc: 'Final project session with mentors.', kind: 'session', icon: 'sun' },
      { time: '11:00 AM', endTime: '', label: 'Snacks', desc: 'Refreshments.', kind: 'break', icon: 'coffee' },
      { time: '12:00 PM', endTime: '1:30 PM', label: 'Lunch', desc: 'Lunch break.', kind: 'meal', icon: 'utensils' },
      { time: '1:30 PM', endTime: '5:00 PM', label: 'Afternoon Session', desc: 'Final rehearsals and refinement.', kind: 'session', icon: 'sun' },
      { time: '3:30 PM', endTime: '', label: 'Snacks', desc: 'Evening refreshments.', kind: 'break', icon: 'coffee' },
      { time: '4:30 PM', endTime: '6:30 PM', label: 'Project Street', desc: 'Final Project Street showcase.', kind: 'highlight', icon: 'sparkles' },
      { time: '7:00 PM', endTime: '8:00 PM', label: 'Dinner', desc: 'Dinner break.', kind: 'meal', icon: 'utensils' },
      { time: '9:30 PM', endTime: '', label: 'Snacks', desc: 'Late-night fuel.', kind: 'break', icon: 'coffee' },
    ]
  },
  {
    ...
    title: 'Grand Finale',
    subtitle: 'Final presentations, certifications, and the closing of Project Space 2026.',
    accent: '#22d3ee',
    events: [
      ...
      { time: '3:30 PM', endTime: '', label: 'Snacks', desc: 'Evening refreshments.', kind: 'break', icon: 'coffee' },
      { time: '6:00 PM', endTime: '', label: 'Gathering at Gallery', desc: 'Final gathering at the presentation gallery by 6:00 PM.', kind: 'highlight', icon: 'sparkles' },
      { time: '6:00 PM', endTime: '8:00 PM', label: 'Presentations at Gallery', desc: 'Final round of project presentations and closing showcase.', kind: 'highlight', icon: 'sparkles' },
      ...
      { time: '9:00 PM', endTime: '', label: 'Presentations Conclusion', desc: 'Closing ceremony and Project Space 2026 wrap-up — 9:00 PM onwards.', kind: 'highlight', icon: 'flag' },
      { time: '11:00 PM', endTime: '', label: 'Certifications Distribution', desc: 'Certificate distribution begins at 11:00 PM onwards.', kind: 'highlight', icon: 'sparkles' },
      { time: '11:30 PM', endTime: '', label: 'Return to Hostels', desc: 'Final return to hostels — Project Space 2026 ends.', kind: 'logistics', icon: 'home' },
    ]
  },
]
  ...
  return (
    <div className="ed-wrap">
      ...
      <style>{`
        ...
        .ed-day::before{content:'';position:absolute;inset:0;border-radius:16px;padding:1px;background:linear-gradient(135deg,var(--accent),transparent 40%,transparent 60%,var(--accent));-webkit-mask:linear-gradient(#fff 0 0) content-box,linear-gradient(#fff 0 0);-webkit-mask-composite:xor;mask-composite:exclude;opacity:0;transition:opacity .4s;pointer-events:none}
        .ed-day.open::before,.ed-day:hover::before{opacity:.6}
        .ed-day.open::before{animation:edBorderRotate 4s linear infinite}
        @keyframes edBorderRotate{0%{background:linear-gradient(0deg,var(--accent),transparent 40%,transparent 60%,var(--accent))}25%{background:linear-gradient(90deg,var(--accent),transparent 40%,transparent 60%,var(--accent))}50%{background:linear-gradient(180deg,var(--accent),transparent 40%,transparent 60%,var(--accent))}75%{background:linear-gradient(270deg,var(--accent),transparent 40%,transparent 60%,var(--accent))}100%{background:linear-gradient(360deg,var(--accent),transparent 40%,transparent 60%,var(--accent))}}
        ...
        .ed-day-num-box{flex-shrink:0;width:68px;height:68px;border-radius:12px;background:linear-gradient(135deg,rgba(255,255,255,.04),rgba(255,255,255,.02));border:1px solid color-mix(in srgb,var(--accent) 25%,transparent);display:flex;flex-direction:column;align-items:center;justify-content:center;position:relative;overflow:hidden;transition:all .35s;gap:5px;padding:10px 6px}
        ...
        .ed-day.open .ed-day-num-box{border-color:color-mix(in srgb,var(--accent) 50%,transparent);transform:scale(1.05)}
        ...
        .ed-day-num-label{font-family:'DM Sans',sans-serif;font-size:.52rem;font-weight:700;color:var(--accent);letter-spacing:1.8px;text-transform:uppercase;position:relative;z-index:1;line-height:1;display:block}
        .ed-day-num{font-family:'Astro','Orbitron','DM Sans',sans-serif;font-size:1.3rem;font-weight:800;color:#fff;line-height:1;position:relative;z-index:1;text-shadow:0 1px 8px color-mix(in srgb,var(--accent) 40%,transparent);letter-spacing:1px;display:block}
