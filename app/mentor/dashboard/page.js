...
import MentorPanelView from '@/app/mentor/dashboard/components/MentorPanelView'
// ── LINE SVG ICONS ──
const I = {
  ...
  target: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>,
  ...
  award: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>,
}
...
@media (max-width:768px){.tsm-table th.proj-col,.tsm-table .tsm-proj{display:none}.tsm-table{min-width:640px}}
                ...
                <div className="tsm-section">
                  <div className="tsm-hdr">PROJECT STATUS OVERVIEW</div>
...
.li-m-expand-btn:hover{color:#fff;border-color:rgba(255,255,255,.2)}
            ...
            {activePage==='panel-view' && <MentorPanelView mentor={mentor}/>}
