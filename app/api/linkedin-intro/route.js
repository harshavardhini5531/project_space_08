...
// Generates unique excitement lines for LinkedIn posts using Claude API

export async function POST(request) {
  try {
    const { projectTitle, technology, projectArea, studentName } = await request.json()

    // Fallback intros if API fails
    const fallbacks = [
